...
<div class="card">
    <div class="card-body p-4">
        <form action="{{ route('admin.evaluasi.star.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row g-3">
                <div class="col-md-6">
            ...
            <textarea name="situasi" class="form-control @error('situasi') is-invalid @enderror mb-3" rows="3" placeholder="Jelaskan situasi atau konteks yang dihadapi..." required>{{ old('situasi') }}</textarea>
            ...
            <textarea name="tugas" class="form-control @error('tugas') is-invalid @enderror mb-3" rows="3" placeholder="Tugas atau tantangan yang harus diselesaikan..." required>{{ old('tugas') }}</textarea>
            ...
            <textarea name="aksi" class="form-control @error('aksi') is-invalid @enderror mb-3" rows="3" placeholder="Langkah-langkah atau tindakan yang diambil..." required>{{ old('aksi') }}</textarea>
            ...
            <textarea name="hasil" class="form-control @error('hasil') is-invalid @enderror mb-3" rows="3" placeholder="Hasil atau dampak dari tindakan yang diambil..." required>{{ old('hasil') }}</textarea>
