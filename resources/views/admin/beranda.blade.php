    ...
    <div id="ai-panel" class="card border-0 shadow-lg d-none" style="position:absolute;bottom:70px;right:0;width:380px;max-height:520px;border-radius:16px;overflow:hidden;">
            ...
            <div class="ai-msg ai-msg-bot mb-3">
                <div class="d-flex gap-2">
                    ...
                    <div class="bg-white rounded-3 p-2 px-3 shadow-sm" style="font-size:.85rem;">
                        Halo! Saya asisten AI Anda. Tanyakan tentang data kehadiran, keuangan, agenda, atau apa saja tentang sekolah. 🎓
                    </div>
                </div>
            </div>
            {{-- AI Ringkasan --}}
        ...
        <div class="card-footer bg-white border-top p-3">
            ...
            <div class="d-flex gap-1 mt-2 flex-wrap">
                ...
                <button class="btn btn-outline-secondary rounded-pill px-2 py-0" style="font-size:.7rem;" onclick="kirimCepat('Ada agenda apa minggu ini?')">
                    <i class="bi bi-calendar me-1"></i>Agenda
                </button>
                <button class="btn btn-outline-secondary rounded-pill px-2 py-0" style="font-size:.7rem;" onclick="kirimCepat('Bagaimana kondisi keuangan bulan ini?')">
