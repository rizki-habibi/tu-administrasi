...
@section('title', 'Buat Dokumen Word')
...
<form action="{{ route('admin.word.store') }}" method="POST" id="wordForm">
    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select id="aiTemplate" class="form-select form-select-sm">
                            ...
                            @foreach($templates as $key => $tpl)
                                <option value="{{ $key }}" {{ $selectedTemplate == $key ? 'selected' : '' }}>{{ $tpl['name'] }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ old('title') }}" required placeholder="Masukkan judul dokumen...">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="category" class="form-select" required>
                            @foreach($categories as $key => $label)
                                <option value="{{ $key }}" {{ old('category','umum')==$key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.word.index') }}" class="btn btn-outline-secondary w-100">
...
document.getElementById('btnLoadTemplate').addEventListener('click', function() {
    ...
    fetch('{{ route("admin.word.template") }}?template=' + template, {
