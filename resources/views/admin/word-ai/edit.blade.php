...
<form action="{{ route('admin.word-ai.update', $word) }}" method="POST" id="wordForm">
    @csrf @method('PUT')
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="btn-toolbar mb-2 border rounded p-2 bg-light d-flex flex-wrap gap-1">
                        ...
                        <div class="btn-group btn-group-sm">
                            <button type="button" class="btn btn-outline-secondary" onclick="insertTable()" title="Tabel"><i class="bi bi-table"></i></button>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-3">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.word-ai.unduh', $word) }}" class="btn btn-outline-info w-100 mb-2">
...
function autoSave() {
    syncContent();
    fetch('{{ route("admin.word-ai.autosave", $word) }}', {
        method: 'POST',
        headers: {
