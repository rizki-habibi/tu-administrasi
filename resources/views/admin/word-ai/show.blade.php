...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('admin.word-ai.unduh', $word) }}" class="btn btn-info text-white"><i class="bi bi-download me-1"></i>Download .docx</a>
        <a href="{{ route('admin.word-ai.edit', $word) }}" class="btn btn-outline-success"><i class="bi bi-pencil me-1"></i>Edit</a>
...
<div class="row g-4">
    ...
    <div class="col-lg-4">
            ...
            <div class="card-body">
                <table class="table table-borderless table-sm mb-0">
                    <tr>
                        ...
                        <td class="fw-semibold">{{ $word->judul }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $word->dibagikan ? 'Ya' : 'Tidak' }}</td>
                    </tr>
                    <tr>
                        <td class="text-muted">Pembuat</td>
                        <td>{{ $word->user->nama ?? '-' }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><small>{{ $word->prompt_ai }}</small></td>
                    </tr>
                    @endif
                </table>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <a href="{{ route('admin.word-ai.unduh', $word) }}" class="btn btn-info text-white w-100 mb-2">
                    <i class="bi bi-file-earmark-arrow-down me-1"></i>Download .docx
                </a>
                <a href="{{ route('admin.word-ai.edit', $word) }}" class="btn btn-outline-success w-100 mb-2">
                    <i class="bi bi-pencil me-1"></i>Edit Dokumen
                </a>
                <button onclick="window.print()" class="btn btn-outline-primary w-100 mb-2">
                    <i class="bi bi-printer me-1"></i>Print
                </button>
                <form action="{{ route('admin.word-ai.destroy', $word) }}" method="POST" onsubmit="return false;" id="deleteForm">
                    @csrf @method('DELETE')
