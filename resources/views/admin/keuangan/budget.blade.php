    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                <thead>
                    <tr><th>#</th><th>Nama Anggaran</th><th>Sumber Dana</th><th>Tahun</th><th class="text-end">Total</th><th class="text-end">Terpakai</th><th class="text-end">Sisa</th><th>Progress</th></tr>
                </thead>
                <tbody>
...
<div class="modal fade" id="addBudgetModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.keuangan.budget.store') }}" method="POST">
                @csrf
