...
<head>
    ...
    <title>Lupa Kata Sandi - TU Administrasi</title>
    ...
    <div class="card-container">
        <div style="text-align:center; margin-bottom: 20px;">
            <div style="width:60px;height:60px;border-radius:14px;background:linear-gradient(135deg,#6366f1,#8b5cf6);display:inline-flex;align-items:center;justify-content:center;margin-bottom:12px;">
                <i class="bi bi-key-fill" style="color:#fff;font-size:1.5rem;"></i>
            </div>
        </div>
        <h3 style="text-align:center;">Lupa Kata Sandi?</h3>
        <p class="subtitle" style="text-align:center;">Masukkan email Anda dan kami akan mengirimkan tautan untuk mengatur ulang kata sandi.</p>
