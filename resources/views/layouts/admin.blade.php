...
<body>
            ...
            <div class="header-right">
                ...
                <div class="dropdown" id="notifDropdown">
                    <button class="notif-btn" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" id="notifToggle">
                        ...
                        @if($unreadNotif > 0)<span class="notif-badge" id="notifBadge"></span>@endif
                    </button>
                    <div class="dropdown-menu dropdown-menu-end p-0" style="width:360px;max-height:440px;border-radius:14px!important;overflow:hidden;">
                        ...
                        <div class="border-top text-center py-2" style="background:#f8fafc;">
                            <a href="{{ route('admin.notification.index') }}" class="text-primary text-decoration-none fw-semibold" style="font-size:.78rem;">Lihat Semua Notifikasi <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="dropdown">
    ...
    <script>
        ...
        function loadNotifications() {
            ...
            fetch('{{ route("admin.notification.json") }}', { headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'application/json' } })
                .then(r => r.json())
                .then(data => {
                    ...
                    const icons = { info: 'bi-info-circle text-primary', warning: 'bi-exclamation-triangle text-warning', success: 'bi-check-circle text-success', danger: 'bi-x-circle text-danger', kehadiran: 'bi-fingerprint text-success', izin: 'bi-calendar2-x text-warning', event: 'bi-calendar-event text-info', pengumuman: 'bi-megaphone text-primary', sistem: 'bi-gear text-secondary' };
                    list.innerHTML = data.notifications.map(n => `
                        <div class="d-flex gap-2 px-3 py-2 border-bottom notif-item" style="transition:.15s;">
