...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('staff.leave.create') }}" class="btn btn-primary"><i class="bi bi-plus-lg"></i> Ajukan Izin</a>
</div>
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge bg-info">{{ ucfirst(str_replace('_',' ',$leave->type)) }}</span></td>
                    ...
                    <td>
                        <a href="{{ route('staff.leave.show', $leave) }}" class="btn btn-sm btn-outline-info"><i class="bi bi-eye"></i></a>
                        @if($leave->status == 'pending')
                            <form action="{{ route('staff.leave.destroy', $leave) }}" method="POST" class="d-inline" onsubmit="return confirm('Batalkan pengajuan?')">
                                @csrf @method('DELETE')
