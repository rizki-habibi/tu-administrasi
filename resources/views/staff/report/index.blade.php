...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('staff.report.create') }}" class="btn btn-primary"><i class="bi bi-plus-lg"></i> Buat Laporan</a>
</div>
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge bg-secondary">{{ ucfirst(str_replace('_',' ',$report->category)) }}</span></td>
                    <td>
                    ...
                    <td>
                        <a href="{{ route('staff.report.show', $report) }}" class="btn btn-sm btn-outline-info"><i class="bi bi-eye"></i></a>
                        @if($report->status == 'draft')
                            <a href="{{ route('staff.report.edit', $report) }}" class="btn btn-sm btn-outline-warning"><i class="bi bi-pencil"></i></a>
                            <form action="{{ route('staff.report.destroy', $report) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus laporan?')">
                                @csrf @method('DELETE')
