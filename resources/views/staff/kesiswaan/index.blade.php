        ...
        <table class="table table-hover mb-0 align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($s->photo)
                        <img src="{{ Storage::url($s->photo) }}" class="rounded-circle" width="35" height="35" style="object-fit:cover;">
                        @else
                    ...
                    <td class="text-center">
                        <a href="{{ route('staff.kesiswaan.show', $s->id) }}" class="btn btn-outline-primary btn-sm"><i class="bi bi-eye"></i></a>
                    </td>
                </tr>
                @empty
