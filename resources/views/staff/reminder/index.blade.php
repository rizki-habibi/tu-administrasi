                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="{{ $isOverdue ? 'text-danger fw-bold' : '' }}">
                            {{ $r->due_date ? \Carbon\Carbon::parse($r->due_date)->translatedFormat('d M Y, H:i') : '-' }}
                        </span>
                        @if($isOverdue)
                    ...
                    <td class="text-center">
                        <form action="{{ route('staff.reminder.complete', $r->id) }}" method="POST" class="d-inline">
                            @csrf @method('PATCH')
    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0 align-middle">
            ...
            <tbody>
                ...
                <tr class="text-muted">
                    <td><s>{{ $r->title }}</s></td>
                    <td>{{ $r->due_date ? \Carbon\Carbon::parse($r->due_date)->translatedFormat('d M Y') : '-' }}</td>
