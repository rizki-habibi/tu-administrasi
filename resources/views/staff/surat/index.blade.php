...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('staff.surat.create', ['jenis'=>'masuk']) }}" class="btn btn-outline-success btn-sm"><i class="bi bi-envelope-arrow-down me-1"></i>Catat Surat Masuk</a>
        <a href="{{ route('staff.surat.create', ['jenis'=>'keluar']) }}" class="btn btn-primary btn-sm"><i class="bi bi-envelope-arrow-up me-1"></i>Buat Surat Keluar</a>
    </div>
</div>
    ...
    <div class="card-body py-3">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-4 d-flex gap-2">
                ...
                <a href="{{ route('staff.surat.index') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-x-lg"></i></a>
            </div>
        </form>
    </div>
</div>
        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="{{ route('staff.surat.show', $surat) }}" class="btn btn-outline-primary btn-sm"><i class="bi bi-eye"></i></a>
                    </td>
                </tr>
                @empty
                <tr>
