...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
    ...
    <a href="{{ route('staff.surat.index') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left me-1"></i>Kembali</a>
</div>
    ...
    <div class="card-body">
        <form action="{{ route('staff.surat.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('staff.surat.index') }}" class="btn btn-outline-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
