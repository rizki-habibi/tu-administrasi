...
@section('title', 'Inventaris & Sarpras')
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('staff.inventaris.show', $item->id) }}" class="btn btn-outline-primary btn-sm"><i class="bi bi-eye"></i></a>
                    </td>
                </tr>
                @empty
...
<div class="modal fade" id="damageModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('staff.inventaris.damage') }}" method="POST" enctype="multipart/form-data">
                @csrf
