...
<div class="card mb-3">
    ...
    <div class="card-body">
        <div class="row g-3">
            <div class="col-md-3"><strong class="text-primary">Situation:</strong><p class="mb-0 small mt-1">{{ Str::limit($a->situation, 100) }}</p></div>
            <div class="col-md-3"><strong class="text-warning">Task:</strong><p class="mb-0 small mt-1">{{ Str::limit($a->task, 100) }}</p></div>
            <div class="col-md-3"><strong class="text-success">Action:</strong><p class="mb-0 small mt-1">{{ Str::limit($a->action, 100) }}</p></div>
            <div class="col-md-3"><strong class="text-danger">Result:</strong><p class="mb-0 small mt-1">{{ Str::limit($a->result, 100) }}</p></div>
        </div>
    </div>
</div>
@empty
...
<div class="modal fade" id="starModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('staff.evaluasi.star.store') }}" method="POST">
                @csrf
