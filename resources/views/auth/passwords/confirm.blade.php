...
<head>
    ...
    <title>Konfirmasi Kata Sandi - TU Administrasi</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .back-link a { color: #6366f1; font-size: .82rem; text-decoration: none; font-weight: 500; }
    </style>
</head>
<body>
    <div class="card-container">
        <div style="text-align:center; margin-bottom: 20px;">
            <div style="width:60px;height:60px;border-radius:14px;background:linear-gradient(135deg,#6366f1,#8b5cf6);display:inline-flex;align-items:center;justify-content:center;margin-bottom:12px;">
                <i class="bi bi-shield-check" style="color:#fff;font-size:1.5rem;"></i>
            </div>
        </div>
        <h3 style="text-align:center;">Konfirmasi Kata Sandi</h3>
        <p class="subtitle" style="text-align:center;">Silakan konfirmasi kata sandi Anda sebelum melanjutkan.</p>
        ...
        <form method="POST" action="{{ route('password.confirm') }}">
            ...
            <div class="form-group">
                ...
                <div class="input-group-custom">
                    ...
                    <input type="password" name="password" placeholder="Masukkan kata sandi" required autocomplete="current-password">
                </div>
