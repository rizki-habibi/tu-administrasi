...
<div class="panduan-header no-print">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a href="{{ route('staf.panduan.index') }}" class="header-btn">
            ...
            <div class="dropdown action-dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{ route('staf.panduan.download', $panduan) }}"><i class="bi bi-filetype-html text-warning"></i> Download HTML</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <form action="{{ route('staf.panduan.upload-drive', $panduan) }}" method="POST" id="formGDrive">
                            @csrf
            ...
            <div class="card-body p-3">
                ...
                <div class="doc-nav-list">
                    @foreach($dokumenList as $d)
                        <a href="{{ route('staf.panduan.show', $d) }}" class="{{ $d->id === $panduan->id ? 'current' : '' }}">
