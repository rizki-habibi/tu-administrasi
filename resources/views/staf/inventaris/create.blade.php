...
<div class="card">
    <div class="card-body p-4">
        <form action="{{ route('staf.inventaris.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="lokasi" class="form-control" value="{{ old('lokasi') }}" placeholder="Contoh: Ruang Guru, Lab IPA" required>
                </div>
                <div class="col-md-4">
