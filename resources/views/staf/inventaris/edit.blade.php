...
<div class="card">
    <div class="card-body p-4">
        <form action="{{ route('staf.inventaris.update', $inventaris) }}" method="POST" enctype="multipart/form-data">
            @csrf @method('PUT')
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="lokasi" class="form-control" value="{{ old('lokasi', $inventaris->lokasi) }}" required>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" name="tanggal_perolehan" class="form-control" value="{{ old('tanggal_perolehan', optional($inventaris->tanggal_perolehan)->format('Y-m-d')) }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Harga Perolehan (Rp)</label>
                    <input type="number" name="harga_perolehan" class="form-control" value="{{ old('harga_perolehan', $inventaris->harga_perolehan) }}" min="0">
                </div>
                <div class="col-md-4">
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="{{ route('staf.inventaris.index') }}" class="btn btn-outline-secondary">Batal</a>
