        ...
        <div class="card border-0 shadow-sm" style="height: calc(100vh - 160px); display:flex; flex-direction:column;">
            <div class="card-header bg-white border-0 py-3">
                <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center justify-content-center rounded-circle" style="width:48px;height:48px;background:linear-gradient(135deg,#10b981,#34d399);">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0" style="font-size:.8rem;">Asisten AI Staff TU SMA Negeri 2 Jember</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-4" id="chat-messages" style="flex:1; overflow-y:auto; background:#f8f9fa;">
                <div class="d-flex gap-3 mb-4">
                    <div class="d-flex align-items-start justify-content-center rounded-circle flex-shrink-0" style="width:36px;height:36px;background:linear-gradient(135deg,#10b981,#34d399);">
                    ...
                    <div class="bg-white rounded-3 p-3 shadow-sm" style="max-width:80%;font-size:.9rem;">
                        ...
                        <p class="mb-2">Saya <strong>SIMPEG-AI</strong>, asisten AI untuk membantu tugas harian Staff TU. Saya siap membantu:</p>
                        <ul class="mb-2">
                            <li>📨 Cara membuat surat & disposisi</li>
                            <li>📋 Panduan pengisian laporan</li>
                            <li>📦 Tips inventaris & pengarsipan</li>
                            <li>🗓️ Kelola jadwal & pengingat</li>
                            <li>💼 Panduan prosedur kerja TU</li>
                            <li>❓ Pertanyaan umum administrasi</li>
                        </ul>
            ...
            <div class="card-footer bg-white border-0 p-3">
                <form id="chat-form" class="d-flex gap-2">
                    ...
                    <button type="submit" class="btn btn-success align-self-end" id="btn-kirim" style="height:40px;width:48px;">
...
chatForm.addEventListener('submit', function(e) {
    ...
    fetch('{{ route("staf.siatu-ai.kirim") }}', {
...
function appendMessage(type, content) {
    ...
    const grad = 'linear-gradient(135deg,#10b981,#34d399)';
    if (type === 'ai') {
...
function showTyping() {
    ...
    div.innerHTML = `<div class="d-flex align-items-start justify-content-center rounded-circle flex-shrink-0" style="width:36px;height:36px;background:linear-gradient(135deg,#10b981,#34d399);"><i class="bi bi-robot text-white" style="font-size:1rem;margin-top:7px;"></i></div><div class="bg-white rounded-3 p-3 shadow-sm"><div class="d-flex gap-1"><div class="typing-dot"></div><div class="typing-dot"></div><div class="typing-dot"></div></div></div>`;
    chatMessages.appendChild(div); chatMessages.scrollTop = chatMessages.scrollHeight; return id;
}
function removeTyping(id) { document.getElementById(id)?.remove(); }
</script>
<style>
.typing-dot { width:8px;height:8px;background:#10b981;border-radius:50%;animation:typing 1.4s infinite ease-in-out; }
