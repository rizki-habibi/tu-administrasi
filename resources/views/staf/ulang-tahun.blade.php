...
<div class="birthday-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <a href="{{ route('staf.beranda') }}" class="btn btn-sm" style="background:rgba(255,255,255,.2);color:#fff;border:1px solid rgba(255,255,255,.3);">
...
function submitUcapan() {
    ...
    fetch('{{ route("staf.ulang-tahun.ucapan") }}', {
        method: 'POST',
        headers: {
