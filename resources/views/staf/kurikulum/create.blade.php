...
@section('judul', 'Unggah Dokumen Kurikulum')

@section('konten')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="bi bi-plus-lg"></i> Unggah Dokumen Kurikulum</h4>
    <a href="{{ route('staf.kurikulum.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Kembali</a>
</div>

<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form action="{{ route('staf.kurikulum-kelola.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row g-3">
                <div class="col-md-8">
                ...
                <div class="col-md-6">
                    <label class="form-label fw-bold">File <span class="text-danger">*</span> <small class="text-muted">(maks 10MB)</small></label>
