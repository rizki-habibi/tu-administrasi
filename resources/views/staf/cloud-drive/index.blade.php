...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
    <div>
        <h5 class="fw-bold mb-1"><i class="bi bi-cloud-fill text-primary me-2"></i>Cloud Drive Saya</h5>
    ...
    <div class="card-body py-3">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="{{ route('staf.cloud-drive.index') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-x-lg"></i></a>
            </div>
        </form>
    </div>
</div>
            ...
            <div class="card-body p-3">
                <div class="d-flex align-items-start justify-content-between mb-2">
                    <div class="d-flex align-items-center gap-2">
                        <div class="rounded-3 d-flex align-items-center justify-content-center" style="width:40px;height:40px;background:linear-gradient(135deg,#6366f1,#818cf8);">
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    <span class="badge bg-info bg-opacity-10 text-info" style="font-size:.75rem;">{{ ucfirst($d->jenis_data) }}</span>
                    <small class="text-muted">{{ $d->created_at->format('d/m/Y') }}</small>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ $d->url_link }}" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-primary flex-grow-1">
...
<div class="modal fade" id="modalTambah" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('staf.cloud-drive.store') }}" method="POST">
            @csrf
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control form-control-sm" required placeholder="Contoh: Backup Dokumen Saya">
                    </div>
...
document.querySelectorAll('.btn-edit').forEach(btn => {
    btn.addEventListener('click', function() {
        document.getElementById('formEdit').action = '{{ route("staf.cloud-drive.update", ":id") }}'.replace(':id', this.dataset.id);
