    ...
    <div class="card-body py-3">
        <form method="GET" class="row g-2 align-items-end">
            ...
            @if(request()->hasAny(['search','kategori','status']))
                <div class="col-md-2">
                    <a href="{{ route('staf.word-ai.index') }}" class="btn btn-sm btn-outline-secondary w-100"><i class="bi bi-x-circle me-1"></i>Atur Ulang</a>
                </div>
            @endif
        </form>
    </div>
                        ...
                        <td class="text-center">
                            <div class="btn-group btn-group-sm">
                                ...
                                @if($doc->pengguna_id == auth()->id())
                                    <a href="{{ route('staf.word-ai.edit', $doc) }}" class="btn btn-outline-success" title="Ubah"><i class="bi bi-pencil"></i></a>
