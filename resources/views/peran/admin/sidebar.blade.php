...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav" id="sidebarNav">
        ...
        {{-- -- Menu Utama -- --}}
        <div class="nav-group {{ request()->routeIs('admin.beranda') ? 'open' : 'open' }}">
        ...
        <div class="nav-group {{ request()->routeIs('admin.halaman-publik.*') ? 'open' : '' }}">
            <div class="nav-group-label" data-toggle="nav-group"><span>Halaman Publik</span><i class="bi bi-chevron-down"></i></div>
            <div class="nav-group-items">
                <div class="nav-item {{ request()->routeIs('admin.halaman-publik.*') && !request()->routeIs('admin.halaman-publik.statistik') && !request()->routeIs('admin.halaman-publik.saran*') ? 'open' : '' }}">
                    <a class="nav-link {{ request()->routeIs('admin.halaman-publik.*') && !request()->routeIs('admin.halaman-publik.statistik') && !request()->routeIs('admin.halaman-publik.saran*') ? 'active' : '' }}" data-toggle="submenu">
                        <i class="bi bi-globe2 icon"></i> <span>Halaman Utama</span> <i class="bi bi-chevron-right arrow"></i>
                    </a>
                    <div class="submenu">
                        <a href="{{ route('admin.halaman-publik.index') }}" class="sub-link {{ request()->routeIs('admin.halaman-publik.index') ? 'active' : '' }}">Semua Konten</a>
                        <a href="{{ route('admin.halaman-publik.create') }}" class="sub-link {{ request()->routeIs('admin.halaman-publik.create') ? 'active' : '' }}">Tambah Konten</a>
                        <a href="{{ route('admin.halaman-publik.index', ['bagian' => 'kinerja']) }}" class="sub-link {{ request('bagian') === 'kinerja' ? 'active' : '' }}">Konten Kinerja</a>
                        <a href="{{ route('admin.halaman-publik.index', ['kategori' => 'galeri']) }}" class="sub-link {{ request('kategori') === 'galeri' ? 'active' : '' }}">Galeri & Media</a>
                        <a href="{{ route('admin.halaman-publik.index', ['kategori' => 'kerjasama']) }}" class="sub-link {{ request('kategori') === 'kerjasama' ? 'active' : '' }}">Kerjasama / MOU</a>
                        <a href="{{ route('admin.halaman-publik.index', ['kategori' => 'dokumen']) }}" class="sub-link {{ request('kategori') === 'dokumen' ? 'active' : '' }}">Dokumen Publik</a>
                    </div>
                </div>
                <div class="nav-item {{ request()->routeIs('admin.halaman-publik.statistik') || request()->routeIs('admin.halaman-publik.saran*') ? 'open' : '' }}">
                    <a class="nav-link {{ request()->routeIs('admin.halaman-publik.statistik') || request()->routeIs('admin.halaman-publik.saran*') ? 'active' : '' }}" data-toggle="submenu">
                        ...
                        @if($saranBaru > 0)<span class="badge bg-danger" style="font-size:.6rem;">{{ $saranBaru }}</span>@endif
                        <i class="bi bi-chevron-right arrow"></i>
                    </a>
                    <div class="submenu">
                        <a href="{{ route('admin.halaman-publik.statistik') }}" class="sub-link {{ request()->routeIs('admin.halaman-publik.statistik') ? 'active' : '' }}">Statistik Pengunjung</a>
                        <a href="{{ route('admin.halaman-publik.saran') }}" class="sub-link {{ request()->routeIs('admin.halaman-publik.saran*') ? 'active' : '' }}">Saran Pengunjung @if($saranBaru > 0)<span class="badge bg-danger" style="font-size:.5rem;margin-left:4px;">{{ $saranBaru }}</span>@endif</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="nav-group {{ request()->routeIs('admin.pegawai.*') || request()->routeIs('admin.kehadiran.*') || request()->routeIs('admin.izin.*') ? 'open' : '' }}">
            <div class="nav-group-label" data-toggle="nav-group"><span>Manajemen Pegawai</span><i class="bi bi-chevron-down"></i></div>
            <div class="nav-group-items">
        ...
        <div class="nav-group {{ request()->routeIs('admin.surat.*') || request()->routeIs('admin.dokumen.*') || request()->routeIs('admin.laporan.*') ? 'open' : '' }}">
            <div class="nav-group-label" data-toggle="nav-group"><span>Administrasi Dokumen</span><i class="bi bi-chevron-down"></i></div>
            <div class="nav-group-items">
        ...
        <div class="nav-group {{ request()->routeIs('admin.kurikulum.*') || request()->routeIs('admin.kesiswaan.*') ? 'open' : '' }}">
            <div class="nav-group-label" data-toggle="nav-group"><span>Akademik & Kurikulum</span><i class="bi bi-chevron-down"></i></div>
            <div class="nav-group-items">
        ...
        <div class="nav-group {{ request()->routeIs('admin.inventaris.*') || request()->routeIs('admin.keuangan.*') ? 'open' : '' }}">
            <div class="nav-group-label" data-toggle="nav-group"><span>Sarana & Keuangan</span><i class="bi bi-chevron-down"></i></div>
            <div class="nav-group-items">
        ...
        <div class="nav-group {{ request()->routeIs('admin.evaluasi.*') || request()->routeIs('admin.akreditasi.*') ? 'open' : '' }}">
            <div class="nav-group-label" data-toggle="nav-group"><span>Evaluasi & Penilaian</span><i class="bi bi-chevron-down"></i></div>
            <div class="nav-group-items">
        ...
        <div class="nav-group {{ request()->routeIs('admin.agenda.*') || request()->routeIs('admin.notifikasi.*') || request()->routeIs('admin.chat.*') || request()->routeIs('admin.ulang-tahun.*') ? 'open' : '' }}">
            <div class="nav-group-label" data-toggle="nav-group"><span>Kegiatan & Komunikasi</span><i class="bi bi-chevron-down"></i></div>
            <div class="nav-group-items">
        ...
        <div class="nav-group {{ request()->routeIs('admin.pengingat.*') || request()->routeIs('admin.panduan.*') || request()->routeIs('admin.word-ai.*') || request()->routeIs('admin.ekspor.*') || request()->routeIs('admin.pengaturan.*') ? 'open' : '' }}">
            <div class="nav-group-label" data-toggle="nav-group"><span>Sistem</span><i class="bi bi-chevron-down"></i></div>
            <div class="nav-group-items">
                ...
                <div class="nav-item {{ request()->routeIs('admin.panduan.*') ? 'open' : '' }}">
                    ...
                    <div class="submenu">
                        <a href="{{ route('admin.panduan.index') }}" class="sub-link {{ request()->routeIs('admin.panduan.index') ? 'active' : '' }}">Pusat Panduan</a>
                        <a href="{{ route('admin.panduan.create') }}" class="sub-link {{ request()->routeIs('admin.panduan.create') ? 'active' : '' }}">Tambah Panduan</a>
                    </div>
                </div>
                <div class="nav-item {{ request()->routeIs('admin.word-ai.*') ? 'open' : '' }}">
                    ...
                    <div class="submenu">
                        <a href="{{ route('admin.word-ai.index') }}" class="sub-link {{ request()->routeIs('admin.word-ai.index') ? 'active' : '' }}">Daftar Dokumen</a>
                        <a href="{{ route('admin.word-ai.create') }}" class="sub-link {{ request()->routeIs('admin.word-ai.create') ? 'active' : '' }}">Buat Dokumen AI</a>
                    </div>
                </div>
                <div class="nav-item {{ request()->routeIs('admin.ekspor.*') ? 'open' : '' }}">
                    ...
                    <div class="submenu">
                        <a href="{{ route('admin.ekspor.index') }}" class="sub-link {{ request()->routeIs('admin.ekspor.index') ? 'active' : '' }}">Ekspor Data</a>
                    </div>
                </div>
