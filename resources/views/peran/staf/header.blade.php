    ...
    <div class="header-right">
        ...
        <div class="dropdown" id="notifDropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end p-0" style="width:360px;max-height:440px;border-radius:14px!important;overflow:hidden;">
                {{-- Dropdown Header --}}
                <div class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom" style="background:#ecfdf5;">
                    <h6 class="mb-0 fw-bold" style="font-size:.85rem;color:#065f46;">Notifikasi</h6>
                    <span class="badge" id="notifCount" style="font-size:.65rem;background:#10b981;color:#fff;">{{ $unreadNotif }}</span>
                </div>
                {{-- Notification List (loaded via AJAX) --}}
                <div id="notifList" style="max-height:320px;overflow-y:auto;">
                    <div class="text-center py-4 text-muted" style="font-size:.8rem;">
                        <div class="spinner-border spinner-border-sm text-success me-1"></div> Memuat...
                    </div>
                </div>
                {{-- Footer Link --}}
                <div class="border-top text-center py-2" style="background:#ecfdf5;">
                    <a href="{{ route('staf.notifikasi.index') }}" class="text-decoration-none fw-semibold" style="font-size:.78rem;color:#065f46;">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li>
                    <a class="dropdown-item" href="{{ route('staf.profil.edit') }}">
                        <i class="bi bi-person-circle me-2" style="color:#10b981;"></i>Profil Saya
                    </a>
                </li>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function loadNotifications() {
            ...
            list.innerHTML = '<div class="text-center py-4 text-muted" style="font-size:.8rem;"><div class="spinner-border spinner-border-sm text-success me-1"></div> Memuat...</div>';
            ...
            .then(data => {
                ...
                if (data.notifications.length === 0) {
                    list.innerHTML = '<div class="text-center py-4 text-muted" style="font-size:.82rem;"><i class="bi bi-bell-slash" style="font-size:1.5rem;color:#10b981;"></i><p class="mb-0 mt-1">Tidak ada notifikasi baru</p></div>';
                    return;
                }
                ...
                list.innerHTML = data.notifications.map(n => `
                    <div class="d-flex gap-2 px-3 py-2 border-bottom notif-item" style="transition:.15s;${!n.sudah_dibaca ? 'background:#ecfdf5;' : ''}">
                        <div class="flex-shrink-0 mt-1">
                            <i class="bi ${icons[n.jenis] || icons.info}" style="font-size:1rem;"></i>
                        </div>
                        <div class="flex-grow-1 overflow-hidden">
                            <div class="fw-semibold" style="font-size:.82rem;color:#065f46;">${n.judul}</div>
