...
class DashboardController extends Controller
{
    ...
    {
        $totalStaff = User::whereIn('peran', User::STAFF_ROLES)->where('aktif', true)->count();
        ...
        $monthlyAttendance = [
            'hadir' => Attendance::where('status', 'hadir')->whereMonth('tanggal', now()->month)->count(),
            'terlambat' => Attendance::where('status', 'terlambat')->whereMonth('tanggal', now()->month)->count(),
            'izin' => Attendance::where('status', 'izin')->whereMonth('tanggal', now()->month)->count(),
            'sakit' => Attendance::where('status', 'sakit')->whereMonth('tanggal', now()->month)->count(),
            'alpha' => Attendance::where('status', 'alpha')->whereMonth('tanggal', now()->month)->count(),
        ];
        ...
        $recentNotifications = Notification::where('pengguna_id', auth()->id())->latest()->take(5)->get();
