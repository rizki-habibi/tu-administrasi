...
class PegawaiController extends Controller
{
    ...
    {
        $query = Pengguna::whereIn('peran', Pengguna::STAFF_ROLES);
    ...
    public function update(Request $request, Pengguna $staff)
    {
        $request->validate([
            'nama' => 'required|string|max:255',
    ...
    public function destroy(Pengguna $staff)
    {
        if ($staff->foto) {
            Storage::disk('public')->delete($staff->foto);
        }
    ...
    public function toggleStatus(Pengguna $staff)
    {
    ...
    {
        $staffs = Pengguna::whereIn('peran', Pengguna::STAFF_ROLES)->latest()->get();
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            while (($row = fgetcsv($handle)) !== false) {
                ...
                if (Pengguna::where('email', $email)->exists()) { $skipped++; continue; }
