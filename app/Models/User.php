...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(Attendance::class, 'pengguna_id');
    }

    public function leaveRequests()
    {
        return $this->hasMany(LeaveRequest::class, 'pengguna_id');
    }
    ...
    {
        return $this->hasMany(Event::class, 'dibuat_oleh');
    }
    ...
    {
        return $this->hasOne(Attendance::class, 'pengguna_id')->whereDate('tanggal', today());
    }
